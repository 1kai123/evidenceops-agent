# Brand Portals Submission Index

Use this as the single entry point for Brand Portals for Brands review, support, or final form filling.
...
3. Complete Submission Pack Zip:
   https://1kai123.github.io/evidenceops-agent/brand-portals-submission-pack.zip

## Copy-Ready Files

- Final form fields: `BRAND_PORTALS_FINAL_SUBMISSION_FIELDS.md`
- Main submission story: `BRAND_PORTALS_SUBMISSION_READY.md`
- BrandKity transfer: `BRANDKITY_TRANSFER_GUIDE.md`
...
These cannot be completed by automation without user-provided personal information or human verification.

1. Complete Devpost student eligibility fields:
   - School English name.
